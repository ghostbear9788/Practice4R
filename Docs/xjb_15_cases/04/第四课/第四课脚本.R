setwd("E:\\Desktop\\R Language\\R Level2\\天善智能学习资料\\谢佳标老师十五大案例资料\\第四课\\第四课")

### 分析案例—新手教程漏斗模型   ###
# 导入新手教程关键路径用户数 
funnel <- read.csv("data/新手教程路径留存人数统计.csv",T)
# 查看funnel数据集
funnel
# 绘制漏斗图
# 对数据进行降序排序
...
#分析案例—游戏点击事件路径分析
data_click <- read.csv("data/data_click.csv",header=F) # 导入点击事件数据
